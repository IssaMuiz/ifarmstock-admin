...
const Sidenav = ({ showSidebar, setShowSidebar }: Sidebar) => {
  const closeSidebar = () => {
  ...
  return (
    <aside className="h-20 overflow-y-auto">
      <div
        className={`fixed w-64 overflow-x-hidden scrollbar  overflow-auto z-20 left-0 top-0 bottom-0 transform transition-transform duration-300  bg-gray-600 xl:translate-x-0 ${
      ...
      >
        ...
        <div className="flex flex-col items-start gap-6 text-white text-base font-semibold mt-10">
          <Link
            ...
            href="/dashboard"
            className="flex gap-5 w-full items-center py-3 px-6 hover:bg-gray-500 cursor-pointer"
          >
            <svg
              width="25px"
              height="25px"
