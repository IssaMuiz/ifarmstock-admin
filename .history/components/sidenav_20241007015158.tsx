...
const Sidenav = ({ showSidebar }: Sidebar) => {
  return (
    <nav className="">
      <div
        className={`fixed w-60 overflow-x-hidden scrollbar h-screen overflow-auto z-20 left-0 top-0 bottom-0 transform transition-transform duration-300  bg-gray-600 ${
