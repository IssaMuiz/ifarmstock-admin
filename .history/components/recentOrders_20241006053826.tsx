...
const RecentOrders = () => {
  ...
  return (
    <div className="bg-white rounded-sm shadow-md grid grid-cols-1 md:col-span-3 overflow-x-auto">
      <h1 className="text-xl font-semibold mb-4">Recent orders</h1>
      <table className="table-auto w-full border-collapse border border-gray-300 text-left">
        <thead>
          <tr>
            <th className="border px-4 py-2">N0.</th>
            ...
            <tr key={order.id}>
              ...
              <td
                className={`px-4 py-2 border border-gray-300 rounded-sm ${
                  order.status === "completed" && "bg-green-300 text-green-600"
                } ${
