...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white h-42 fixed top-0 left-0 right-0">
      <div className="mx-auto flex justify-between p-5">
        <div className="leftnav flex gap-5">
          <svg
          ...
          <input type="text" placeholder="Search" className="p-3 border" />
        </div>
