...
const Sidenav = ({ showSidebar }: Sidebar) => {
  return (
    <nav className="">
      <div
        className={`fixed w-60 overflow-x-hidden scrollbar h-auto overflow-auto z-20 left-0 top-0 bottom-0 transform transition-transform duration-300 md:translate-x-0  bg-gray-600 ${
