...
const RecentOrders = () => {
  ...
  return (
    <div className="bg-white rounded-sm shadow-md  overflow-x-auto">
      ...
      <table className="table-auto w-full text-xs font-semibold text-gray-400 text-left">
        <thead>
        ...
        <tbody className="">
          {orders.map((order) => (
            <tr key={order.id} className="border-b border-gray-300 ">
              <td className=" px-1 py-2">{order.id}</td>
              <td className="px-1 py-2">
                <div
                  className={` p-1 mr-5 w-max rounded-sm ${
              ...
              <td className="px-1 py-2 ">{order.customerName}</td>
              <td className=" px-1 py-2 mr-4">{order.date}</td>
              <td className="px-1 py-2 ">
