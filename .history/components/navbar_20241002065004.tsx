...
const Navbar = () => {
  ...
  return (
    <nav className="flex justify-between w-full overflow-x-auto items-center fixed top-0 left-0 right-0 h-50 px-6 py-4 border-b shadow-md mx-auto">
      ...
      <div className="flex w-full items-center gap-2">
        ...
        <div className="flex items-center gap-3 ml-3 justify-end">
          <Image
