    ...
    >
      <div className="mx-auto flex justify-between p-2">
        ...
        <div className="right-nav flex items-center gap-1 md:gap-3 ml-2">
          ...
          <div className="relative flex items-center gap-2 cursor-pointer hover:bg-gray-100 ">
            <Image
            ...
            <div className="bg-white shadow top-14 right-10 absolute">
              <div className="p-5 flex w-52 flex-col gap-5">
                <p>Profile</p>
                <p>Sign Out</p>
              </div>
            </div>
