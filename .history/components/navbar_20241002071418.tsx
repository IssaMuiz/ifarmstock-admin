...
const Navbar = () => {
  ...
  return (
    <nav className="shadow-md p-4 w-full h-50">
      <div className="flex justify-between items-center fixed top-0 left-0 right-0  px-6 py-4 border-b shadow-md mx-auto">
        <div className="flex gap-3 w-auto items-center">
          ...
          <Link href="/" className="left-nav flex gap-3 items-center">
            <h1 className="md:text-2xl hidden md:flex font-semibold text-xl">
              iFarmStock
            </h1>
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="flex w-auto flex-shrink-0 items-center gap-2">
