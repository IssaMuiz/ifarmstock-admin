      ...
      <div className="mx-auto flex justify-between p-2">
        <div className="leftnav flex-1 flex gap-5 items-center">
          ...
          <input
            type="text"
            placeholder="Search"
            className="p-1 bg-gray-200 rounded-md max-w-96 flex-1 border outline-none"
          />
        </div>
