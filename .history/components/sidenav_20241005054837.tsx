...
const Sidenav = (showSidebar: Sidebar) => {
  return (
    <nav className="">
      <div
        className={`fixed mt-28overflow-x-hidden scrollbar h-auto overflow-auto z-20 left-0 top-0 bottom-0 w-60 transform transition-transform duration-300  bg-gray-600 ${
