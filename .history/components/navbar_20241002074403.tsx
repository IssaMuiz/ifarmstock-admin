...
const Navbar = () => {
  ...
  return (
    <nav className="shadow-md p-4 w-full fixed top-0 left-0 right-0">
      <div className="container flex justify-between items-center mx-auto">
        <div className="flex flex-1 gap-3 max-w-36 items-center">
        ...
        <div className="relative flex items-center gap-2">
          <div className="hidden md:flex absolute md:static md:gap-1 lg:gap-5">
            <Link
