      ...
      <div className="mx-auto flex justify-between p-2">
        ...
        <div className="right-nav flex items-center gap-1 md:gap-3 ml-2">
          <div className="relative cursor-pointer hover:bg-gray-300 rounded-sm p-2">
            ...
            <span className=" absolute flex items-center justify-center font-semibold top-0 left-6 bg-green-500 p-1 h-6 w-6 rounded-full">
              3
            </span>
          </div>
          <div className="relative ">
            ...
            <div className="bg-white shadow top-14 -right-2 absolute w-60 md:w-[19rem] text-xl font-semibold rounded-sm ">
              <div className="flex flex-col gap-5">
                <p className="hover:bg-gray-300 cursor-pointer px-3 py-2 mt-5 transition-all ease-in-out duration-300">
                  Profile
                </p>

                <p className="hover:bg-gray-300 cursor-pointer px-3 py-2 mb-2 transition-all ease-in-out duration-300 border-t border-gray-300-">
                  Sign Out
                </p>
              </div>
            </div>
