      ...
      <div className="mx-auto flex justify-between p-2">
        ...
        <div className="right-nav flex items-center gap-1 md:gap-3 ml-2">
          <svg
            ...
            height="40"
            viewBox="0 0 24 24"
            className="fill:#1A1A1A; cursor-pointer hover:bg-gray-300 p-1 rounded-sm"
          >
          ...
          <div className="flex items-center gap-2 cursor-pointer hover:bg-gray-100 p-1">
            <Image
            ...
            />
            <div className=" flex-col hidden md:flex text-base">
