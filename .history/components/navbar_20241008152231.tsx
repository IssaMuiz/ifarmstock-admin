      ...
      <div className="mx-auto flex justify-between p-2">
        ...
        <div className="right-nav flex items-center gap-1 md:gap-3 ml-2">
          ...
          <div className="relative ">
            ...
            <div className="bg-white shadow top-14 -right-2 absolute w-60 md:w-[19rem] text-xl font-semibold rounded-sm p-2">
              <div className="flex flex-col gap-7">
                <p className="hover:bg-gray-300 cursor-pointer p-2">Profile</p>
