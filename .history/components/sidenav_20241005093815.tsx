...
const Sidenav = ({ showSidebar }: Sidebar) => {
  return (
    <nav className="">
      <div
        className={`fixed w-60 overflow-x-hidden scrollbar h-auto overflow-auto md:flex md-w-1/5 md:relative z-20 left-0 top-0 bottom-0 transform transition-transform duration-300  bg-gray-600 ${
