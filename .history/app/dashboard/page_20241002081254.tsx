...
const DashBoard = () => {
  ...
  return (
    <section className="mt-40">
      ...
      <div className="grid-cols-1 md:grid-cols-4 space-y-5 items-center w-full mt-20">
        <div className="bg-gray-200 p-8 rounded-md w-full">
          <p>Profit</p>
          <p className="flex items-center text-xl mt-1 font-semibold">
            $20,000
            <span className="flex text-end bg-green-300 ml-14 gap-2 items-center p-1 rounded-md text-base text-green-700">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
