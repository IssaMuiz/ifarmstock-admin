    ...
    <section className="mt-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mt-5 shadow-md">
        <div className="bg-white">
          ...
          <div className="bg-green-200 text-2xl font-semibold text-center p-3 text-green-600 mx-5 h-20 mt-5 rounded-sm">
            {148}
          </div>
          <div className="flex justify-between items-center p-2 mx-5 font-semibold">
            <p>Active pages</p>
            <p>Users</p>
          </div>
          <hr />
