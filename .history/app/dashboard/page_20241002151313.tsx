...
const DashBoard = () => {
  ...
  return (
    <section className="mt-32">
      ...
      <div className="grid-cols-1 space-y-5 md:flex gap-4 items-center w-full mt-20">
        ...
        <div className="bg-gray-200 p-8 rounded-md w-full">
          ...
          <p className="flex items-center text-xl mt-1 font-semibold">
            20
            <span className="flex bg-green-300 ml-26 gap-2 items-center p-1 rounded-md text-base text-green-700">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
