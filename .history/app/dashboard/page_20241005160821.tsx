    ...
    <section className="mt-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mt-5 shadow-md">
        <div className="bg-white">
          <h1 className="mx-8 text-xl font-semibold">Active users</h1>
          <div className="bg-green-200 text-2xl font-semibold text-center p-3 text-green-600 mx-8 h-14 rounded-sm">
            {148}
          </div>
