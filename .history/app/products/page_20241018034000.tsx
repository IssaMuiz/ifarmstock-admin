                    ...
                    <tr key={product._id} className="border-b border-gray-300">
                      ...
                      <td className="px-3 py-2 relative">
                        <svg
                          ...
                          strokeWidth={1.5}
                          stroke="currentColor"
                          className="size-6 cursor-pointer hover:bg-gray-100 rounded-sm"
                        >
                          <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                        ...
                        {showDropdown === product._id && (
                          <div className="bg-white shadow-xl top-14 -right-2 mr-5 absolute w-32 md:w-[12rem] text-xl font-semibold rounded-sm z-20">
                            <div className="flex flex-col gap-3">
                              <p className="hover:bg-gray-300 cursor-pointer px-4 py-2 mt-2 transition-all ease-in-out duration font-semibold-300 text-xs text-green-600">
                                Add
                              </p>

                              <p className="hover:bg-gray-300 cursor-pointer px-4 py-2 mb-1 transition-all ease-in-out duration-300 border-gray-300 text-xs font-semibold text-blue-600">
                                Edit
                              </p>
                              <hr />
                              <p className="hover:bg-gray-300 cursor-pointer px-4 py-2 mb-1 transition-all ease-in-out duration-300 border-gray-300 text-xs font-semibold text-red-600">
                                Delete
                              </p>
                            </div>
                          </div>
