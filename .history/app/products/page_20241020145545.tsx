...
const Products = () => {
  ...
  const [editingProduct, setEditingProducts] = useState<Product | null>(null);
  ...
  const handleSaveEdit = async () => {
    try {
      await axios.put(`/api/products/${editingProduct?._id}`, editedProduct);
                        ...
                        {showDropdown === product._id && (
                          ...
                          >
                            <ul className="flex flex-col gap-3">
                              <li className="hover:bg-gray-300 cursor-pointer px-4 py-2 mt-2 transition-all ease-in-out duration font-semibold-300 text-sm text-green-600">
                                Add
                              </li>

                              <li className="hover:bg-gray-300 cursor-pointer px-4 py-2 mb-1 transition-all ease-in-out duration-300 border-gray-300 text-sm font-semibold text-blue-600">
                                Edit
                              </li>
                              <hr />
                              <li
