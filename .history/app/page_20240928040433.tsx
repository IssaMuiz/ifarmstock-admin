            ...
            <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
              <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4 flex flex-col ">
                ...
                <div
                  ...
                  className="bg-green-600 w-max p-2 text-white text-lg rounded-md flex gap-2 items-center font-semibold mx-auto mt-2 hover:bg-green-700 px-3 hover:shadow-lg"
                >
                  <Image
